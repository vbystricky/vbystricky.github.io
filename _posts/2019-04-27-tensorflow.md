...
тензор - это просто название для многомерного массива данных. 
...
результата операции сложения. А еще было создана два ребра из вершин с константами в вершину с операцией. Именно ссылку на вершину, представляющую
